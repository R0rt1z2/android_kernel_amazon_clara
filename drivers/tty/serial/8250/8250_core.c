...
static unsigned long long fos_console_on;
static void univ8250_console_get_fos_console_on(void)
{
	fos_console_on = (idme_get_fos_flags_value() & FOS_FLAGS_CONSOLE_ON);
}
				   ...
				   unsigned int count)
{
	...
	if (likely(!(fos_console_on))) {
		pr_info_once("skip to write 8250 console\n");
		return;
	}
...
static int __init univ8250_console_init(void)
{
	...
	univ8250_console_get_fos_console_on();
