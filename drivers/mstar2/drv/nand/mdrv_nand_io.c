...
U8 au8_SpareBuf[1664] UNFD_ALIGN1;
...
U32 drvNAND_WriteCIS_for_ROM(NAND_FLASH_INFO_t * pNandInfo)
{
    ...
    U16 u16_PBA, WrittenLPIdx=0, u16_tmp;
    U32 u32_PageIdx;
    U8 u8_CISIdx;
    ...
    for (u16_PBA = 0; u16_PBA < 10; u16_PBA++) {
        ...
        **/
        ...
        {
            drvNAND_WriteDummyToPages(ga_tPairedPageMap[WrittenLPIdx].u16_LSB+1, ga_tPairedPageMap[1].u16_LSB-1, u32_PageIdx);
        ...
        **/
        if(pNandDrv->u8_CellType == 1)  // MLC
        {
            if(drvNAND_IsPageLP(pNandInfo->u8_PairPageMapLoc, &u16_tmp))
                drvNAND_WriteDummyToPages(
                    ...
                    ga_tPairedPageMap[u16_tmp].u16_LSB-1, u32_PageIdx);
            else
        ...
        drvNAND_WriteDummyToPages(
            ga_tPairedPageMap[WrittenLPIdx].u16_LSB+1, 
            pNandDrv->u16_BlkPageCnt-1, u32_PageIdx);
